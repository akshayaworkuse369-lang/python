...
#12 Check whether a number lies between 1 and 100.
...
#14 ATM withdrawal (check balance before withdrawal).
...
#15 Movie ticket pricing: Child (<12) → ₹100 Adult → ₹200 Senior (>60) → ₹150
